...
function Page404() {
  ...
  return (
    ...
    <div className="page404Row">
      <div className="page404Svg">
      ...
      <div className="page404Text">
        <h1>404</h1>
        <h2>UH OH! Parece que estas perdido.</h2>
        <p>Da click en el boton de abajo para regresar a la pagina de inicio.</p>
        <Link href='/' passHref>
